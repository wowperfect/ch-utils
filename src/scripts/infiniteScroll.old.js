// ==UserScript==
// @name cohost infinite scroll
// @namespace https://wowperfect.net
// @version 1.2.1
// @description adds infinite scroll to cohost
// @author mint @mintexists, meadow @wowperfect
// @match https://cohost.org/
// @match https://cohost.org/rc/bookmarks
// @match https://cohost.org/rc/dashboard*
          ...
          if (id == 'app') {
            ...
            Object.defineProperty(React, "createElement", {
              value(type, props, ...children) {
                ...
                if (props?.className == 'flex flex-col gap-12') {
